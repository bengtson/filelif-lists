defmodule Lists.DayEntry do
  ...
  EEx.function_from_file(:def, :base, Path.expand("./templates/dayentry.html.eex"), [
    :date,
    :overdue
  ])

  EEx.function_from_file(:def, :dayletter, Path.expand("./templates/dayentry.letter.html.eex"), [
    :entry
  ])
  ...
  def listdays(date) do
    cond do
      date == "overdue" ->
        date = Timex.now(Timex.Timezone.local())
